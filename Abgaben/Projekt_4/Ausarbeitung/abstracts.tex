...
\begin{align*} 
  ...
  x_1 + x_6 &= 2 \text{  }(III)\\
  x_3 + x_7 &= 3 \text{  }(IV)\\
  x_i \geq 0 \text{, } i \in \{1, 2, 3, 4, 5, 6, 7\}
\end{align*}
...
\begin{figure}[H]
  ...
  \begin{tabular}{l|c c c c c}
    & $\begin{bmatrix} 2\\1\\3\\-3\\0\\0\\0 \end{bmatrix}$ & $\begin{bmatrix} 1\\0\\3\\0\\1\\0\\0 \end{bmatrix}$ & $\begin{bmatrix}1\\0\\3\\0\\3\\\\0\end{bmatrix}$ & $\begin{bmatrix}2\\2\\0\\0\\0\\0\\3\end{bmatrix}$ & $\begin{bmatrix}2\\1\\1\\0\\2\\0\\2\end{bmatrix}$\\
    \hline
    $I$ & \xmark & & & & \\
    $II$ & \cmark & & & & \\
    $III$ & \cmark & & & & \\
