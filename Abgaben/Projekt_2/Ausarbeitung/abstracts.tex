...
$$ I -\frac{ss^TA}{s^TAs} + \frac{A^{-1}yy^T}{y^Ts} + \frac{ss^TA}{y^Ts} - \frac{A^{-1}ys^TA}{y^Ts} + \frac{ss^TA}{y^Ts} - \frac{sy^T}{y^Ts} -\frac{ss^TA}{y^Ts}  + \frac{A^{-1}ys^TA}{y^Ts} - \frac{ss^TA}{y^Ts} $$

$$ + \frac{ss^TA}{s^TAs} + \frac{sy^T}{y^Ts} - \frac{A^{-1}yy^T}{y^Ts} + \frac{sy^T}{y^Ts} - \frac{sy^TA^{-1}yy^T}{(y^Ts)^2} -\frac{ss^TA}{y^Ts} + \frac{y^TA^{-1}yss^TA}{(y^Ts)^2}  $$

$$ + \frac{ss^TA}{y^Ts} - \frac{y^TA^{-1}yss^TA}{(y^Ts)^2} -\frac{sy^T}{y^Ts} + \frac{y^TA^{-1}ysy^T}{(y^Ts)^2} $$ 
