...
$$ I \textcolor{red}{-\frac{ss^T}{s^Ts}} \textcolor{blue}{+\frac{yy^T}{y^Ts}} \textcolor{green}{+\frac{ss^T}{y^Ts}} \textcolor{orange}{-\frac{ys^T}{y^Ts}} \textcolor{violet}{+\frac{ss^T}{y^Ts}} \textcolor{magenta}{-\frac{sy^T}{y^Ts}} \textcolor{green}{-\frac{ss^T}{y^Ts}} \textcolor{orange}{+\frac{ys^T}{y^Ts}} \textcolor{violet}{-\frac{ss^T}{y^Ts}} \textcolor{red}{+\frac{ss^T}{s^Ts}} \textcolor{magenta}{+\frac{sy^T}{y^Ts}} \textcolor{blue}{-\frac{yy^T}{y^Ts}} + \frac{sy^T}{y^Ts} $$
