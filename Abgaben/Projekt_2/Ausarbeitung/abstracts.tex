...
% TODO: Warum könnte die Suchrichtung beim BFGS-Verfahren keine Abstiegsrichtung sein?
...
\begin{figure}[H]
  ...
  \begin{tabular}{l|c|r}
    ...
    \hline
  \end{tabular}
  \caption{Verlauf von \lstinline[basicstyle=\ttfamily\color{black}]|InverseBFGS| für die 200-dim. Rosenbrock-Funktion bei einer Genauigkeit von
          $10^{-8}$.}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{l|c|r}
    ...
    \hline
  \end{tabular}
  \caption{Verlauf von \lstinline[basicstyle=\ttfamily\color{black}]|fminunc| für die 200-dim. Rosenbrock-Funktion bei einer Genauigkeit von
