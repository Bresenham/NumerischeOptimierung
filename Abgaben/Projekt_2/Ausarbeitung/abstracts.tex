...
\begin{itemize}
  ...
  \end{itemize}
  \item Man könnte, wie in den Vorlesungsfolien beschrieben, die Matrix $\frac{y^Ts}{y^Ty}\cdot I_n$ verwenden
\end{itemize}

Um herauszufinden, welche dieser Methoden am besten geeignet ist (d.h. die richtig Lösung in der kürzesten Zeit findet),
wird die Laufzeit des inversen BFGS-Verfahrens bestimmt:
...
\begin{figure}[H]
  ...
  \begin{minipage}{.3\textwidth}
    ...
    \end{tikzpicture}
  \end{minipage}
  \caption{Vergleich der Rechenzeit für eine Genauigkeit von $10^{-8}$ gemittelt über 100 Durchläufe}
\end{figure}
