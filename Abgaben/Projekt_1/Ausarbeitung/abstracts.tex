...
Vergleich der Rechenzeit in Sekunden für die Funktionen $f, g, h$ mit dem Bisektions- und Mutation-Selektion-Verfahren sowie
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+ [nodes near coords=Bisekt.] table [y index=1] \dataset;
        \addplot+ [nodes near coords=Mut.-Selekt.] table [y index=2] \dataset;
        \addplot+ [nodes near coords=fminsearch] table [y index=3] \dataset;
    \end{axis}
    \draw[black, thick] (0.5625, -2.6) -- (1.71, -2.6); % 1.145
    \draw[black, thick] (6.15, -2.6) -- (7.3, -2.6);
    \draw[black, thick] (11.7375, -2.6) -- (12.89, -2.6);
\end{tikzpicture}
  \caption{Vergleich der Rechenzeit}
\end{figure}
