...
\begin{figure}[H]
  ...
  \pgfplotstableread{
    ...
    1 0.0       1212.082227   1.254401
    2 0.0       16.337017     3.398372
  }\dataset
  \begin{tikzpicture}
    \begin{axis}[
        width=15cm,
        ...
        ytick=\empty,
        extra y ticks={0,100,250,500,1000},
        extra y tick labels={{0},{100},{250},{500},{1000}},
        xtick=data,
        xticklabels={
            h(x),
            f(x),
    ...
    \end{axis}
    \draw[black, thick] (0.56, -2.6) -- (1.72, -2.6); % 1.145
    \draw[black, thick] (6.15, -2.6) -- (7.31, -2.6);
    \draw[black, thick] (11.7375, -2.6) -- (12.95, -2.6);
\end{tikzpicture}
